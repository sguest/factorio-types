...
enum events {
    ...
    on_player_super_forced_selected_area = 128,
    on_player_toggled_alt_mode = 129,
    on_player_toggled_map_editor = 130,
    on_player_trash_inventory_changed = 131,
    on_player_unbanned = 132,
    on_player_unmuted = 133,
    on_player_used_capsule = 134,
    on_player_used_spidertron_remote = 135,
    on_post_entity_died = 136,
    on_post_segmented_unit_died = 137,
    on_pre_build = 138,
    on_pre_chunk_deleted = 139,
    on_pre_entity_settings_pasted = 140,
    on_pre_ghost_deconstructed = 141,
    on_pre_ghost_upgraded = 142,
    on_pre_permission_group_deleted = 143,
    on_pre_permission_string_imported = 144,
    on_pre_player_crafted_item = 145,
    on_pre_player_died = 146,
    on_pre_player_left_game = 147,
    on_pre_player_mined_item = 148,
    on_pre_player_removed = 149,
    on_pre_player_toggled_map_editor = 150,
    on_pre_robot_exploded_cliff = 151,
    on_pre_scenario_finished = 152,
    on_pre_script_inventory_resized = 153,
    on_pre_surface_cleared = 154,
    on_pre_surface_deleted = 155,
    on_redo_applied = 156,
    on_research_cancelled = 157,
    on_research_finished = 158,
    on_research_moved = 159,
    on_research_queued = 160,
    on_research_reversed = 161,
    on_research_started = 162,
    on_resource_depleted = 163,
    on_robot_built_entity = 164,
    on_robot_built_tile = 165,
    on_robot_exploded_cliff = 166,
    on_robot_mined = 167,
    on_robot_mined_entity = 168,
    on_robot_mined_tile = 169,
    on_robot_pre_mined = 170,
    on_rocket_launch_ordered = 171,
    on_rocket_launched = 172,
    on_runtime_mod_setting_changed = 173,
    on_script_inventory_resized = 174,
    on_script_path_request_finished = 175,
    on_script_trigger_effect = 176,
    on_sector_scanned = 177,
    on_segment_entity_created = 178,
    on_segmented_unit_created = 179,
    on_segmented_unit_damaged = 180,
    on_segmented_unit_died = 181,
    on_selected_entity_changed = 182,
    on_singleplayer_init = 183,
    on_space_platform_built_entity = 184,
    on_space_platform_built_tile = 185,
    on_space_platform_changed_state = 186,
    on_space_platform_mined_entity = 187,
    on_space_platform_mined_item = 188,
    on_space_platform_mined_tile = 189,
    on_space_platform_pre_mined = 190,
    on_spider_command_completed = 191,
    on_string_translated = 192,
    on_surface_cleared = 193,
    on_surface_created = 194,
    on_surface_deleted = 195,
    on_surface_imported = 196,
    on_surface_renamed = 197,
    on_technology_effects_reset = 198,
    on_territory_created = 199,
    on_territory_destroyed = 200,
    on_tick = 201,
    on_tower_mined_plant = 202,
    on_tower_planted_seed = 203,
    on_tower_pre_mined_plant = 204,
    on_train_changed_state = 205,
    on_train_created = 206,
    on_train_schedule_changed = 207,
    on_trigger_created_entity = 208,
    on_trigger_fired_artillery = 209,
    on_udp_packet_received = 210,
    on_undo_applied = 211,
    on_unit_added_to_group = 212,
    on_unit_group_created = 213,
    on_unit_group_finished_gathering = 214,
    on_unit_removed_from_group = 215,
    on_worker_robot_expired = 216,
    script_raised_built = 217,
    script_raised_destroy = 218,
    script_raised_destroy_segmented_unit = 219,
    script_raised_revive = 220,
    script_raised_set_tiles = 221,
    script_raised_teleported = 222
}
