...
enum events {
    ...
    on_research_queued = 152,
    on_research_reversed = 153,
    on_research_started = 154,
    on_resource_depleted = 155,
    on_robot_built_entity = 156,
    on_robot_built_tile = 157,
    on_robot_exploded_cliff = 158,
    on_robot_mined = 159,
    on_robot_mined_entity = 160,
    on_robot_mined_tile = 161,
    on_robot_pre_mined = 162,
    on_rocket_launch_ordered = 163,
    on_rocket_launched = 164,
    on_runtime_mod_setting_changed = 165,
    on_script_inventory_resized = 166,
    on_script_path_request_finished = 167,
    on_script_trigger_effect = 168,
    on_sector_scanned = 169,
    on_segment_entity_created = 170,
    on_selected_entity_changed = 171,
    on_singleplayer_init = 172,
    on_space_platform_built_entity = 173,
    on_space_platform_built_tile = 174,
    on_space_platform_changed_state = 175,
    on_space_platform_mined_entity = 176,
    on_space_platform_mined_item = 177,
    on_space_platform_mined_tile = 178,
    on_space_platform_pre_mined = 179,
    on_spider_command_completed = 180,
    on_string_translated = 181,
    on_surface_cleared = 182,
    on_surface_created = 183,
    on_surface_deleted = 184,
    on_surface_imported = 185,
    on_surface_renamed = 186,
    on_technology_effects_reset = 187,
    on_tick = 188,
    on_train_changed_state = 189,
    on_train_created = 190,
