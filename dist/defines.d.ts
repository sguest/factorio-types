...
namespace prototypes {
    ...
    enum map-gen-presets {
        map-gen-presets = 0
    }
    enum map-settings {
        map-settings = 0
    }
    enum module-category {
        module-category = 0
    }
    enum mouse-cursor {
        mouse-cursor = 0
    }
    enum noise-expression {
        noise-expression = 0
    }
    enum noise-layer {
        noise-layer = 0
    ...
    enum tips-and-tricks-item {
        tips-and-tricks-item = 0
    }
    enum tips-and-tricks-item-category {
        tips-and-tricks-item-category = 0
    }
    enum trigger-target-type {
    ...
    enum utility-constants {
        utility-constants = 0
    }
    enum utility-sounds {
        utility-sounds = 0
    }
    enum utility-sprites {
        utility-sprites = 0
    }
    enum virtual-signal {
        virtual-signal = 0
