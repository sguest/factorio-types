...
enum events {
    ...
    on_post_segmented_unit_died = 130,
    on_pre_build = 131,
    on_pre_chunk_deleted = 132,
    on_pre_entity_settings_pasted = 133,
    on_pre_ghost_deconstructed = 134,
    on_pre_ghost_upgraded = 135,
    on_pre_permission_group_deleted = 136,
    on_pre_permission_string_imported = 137,
    on_pre_player_crafted_item = 138,
    on_pre_player_died = 139,
    on_pre_player_left_game = 140,
    on_pre_player_mined_item = 141,
    on_pre_player_removed = 142,
    on_pre_player_toggled_map_editor = 143,
    on_pre_robot_exploded_cliff = 144,
    on_pre_scenario_finished = 145,
    on_pre_script_inventory_resized = 146,
    on_pre_surface_cleared = 147,
    on_pre_surface_deleted = 148,
    on_redo_applied = 149,
    on_research_cancelled = 150,
    on_research_finished = 151,
    on_research_moved = 152,
    on_research_queued = 153,
    on_research_reversed = 154,
    on_research_started = 155,
    on_resource_depleted = 156,
    on_robot_built_entity = 157,
    on_robot_built_tile = 158,
    on_robot_exploded_cliff = 159,
    on_robot_mined = 160,
    on_robot_mined_entity = 161,
    on_robot_mined_tile = 162,
    on_robot_pre_mined = 163,
    on_rocket_launch_ordered = 164,
    on_rocket_launched = 165,
    on_runtime_mod_setting_changed = 166,
    on_script_inventory_resized = 167,
    on_script_path_request_finished = 168,
    on_script_trigger_effect = 169,
    on_sector_scanned = 170,
    on_segment_entity_created = 171,
    on_segmented_unit_created = 172,
    on_segmented_unit_damaged = 173,
    on_segmented_unit_died = 174,
    on_selected_entity_changed = 175,
    on_singleplayer_init = 176,
    on_space_platform_built_entity = 177,
    on_space_platform_built_tile = 178,
    on_space_platform_changed_state = 179,
    on_space_platform_mined_entity = 180,
    on_space_platform_mined_item = 181,
    on_space_platform_mined_tile = 182,
    on_space_platform_pre_mined = 183,
    on_spider_command_completed = 184,
    on_string_translated = 185,
    on_surface_cleared = 186,
    on_surface_created = 187,
    on_surface_deleted = 188,
    on_surface_imported = 189,
    on_surface_renamed = 190,
    on_technology_effects_reset = 191,
    on_territory_created = 192,
    on_territory_destroyed = 193,
    on_tick = 194,
    on_tower_mined_plant = 195,
    on_tower_planted_seed = 196,
    on_tower_pre_mined_plant = 197,
    on_train_changed_state = 198,
    on_train_created = 199,
    on_train_schedule_changed = 200,
    on_trigger_created_entity = 201,
    on_trigger_fired_artillery = 202,
    on_udp_packet_received = 203,
    on_undo_applied = 204,
    on_unit_added_to_group = 205,
    on_unit_group_created = 206,
    on_unit_group_finished_gathering = 207,
    on_unit_removed_from_group = 208,
    on_worker_robot_expired = 209,
    script_raised_built = 210,
    script_raised_destroy = 211,
    script_raised_destroy_segmented_unit = 212,
    script_raised_revive = 213,
    script_raised_set_tiles = 214,
    script_raised_teleported = 215
}
