...
/**
 * Defines the amount of an item required to research one unit of a {@link technology | prototype:TechnologyPrototype}. The first member of the tuple is the name of a {@link ItemPrototype | prototype:ItemPrototype} and the second is the amount. Amount must not be 0.
 * @example ```
